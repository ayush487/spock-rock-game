...
const computerRandomChoice = () => {
  ...
  else if(computerChoiceNumber === 1) computerChoice = 'paper'
  else if(computerChoiceNumber === 2) computerChoice  = 'scissors'
  else if(computerChoiceNumber === 3) computerChoice = 'lizard'
  else computerChoice = 'spock'
}

// Add 'select styling & computerChoice
